...
### 前置准备
  - 字体：
    因为等宽字体每个字符的宽度都是一致的，因此代码对齐效果很好，为了中英文显示一致中文也采用等宽字体。
    字体英文名里的Mono即为等宽含义。
    有一些中文字体同时含有英文字符集，最终视觉效果更统一。
    需要注意的是，需要选择字体系列里的Mono即等宽的样式。
    常见的有：
    ``` text
    Noto Sans 出品的 Sarasa Gothic 更纱黑体。
